          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3"><strong>Add & Update lessons here</strong></h1>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                   ...
                                   <a href="addclass.php"> <p class="card-text"> Click Here To Add Class</p> </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <a href="contentedit.php">  <p class="card-text">Click Here To Update Class</p> </a>
                                </div>
                            </div>
                        </div>
